...
SimpleForm.setup do |config|
  ...
  config.wrappers :horizontal_search_form, :tag => 'div',
                                           :class => 'form-group row' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
    b.optional :pattern
    b.optional :min_max
    b.use :label, :class => 'col-sm-2 col-form-label text-right'
    b.wrapper :grid_wrapper, :tag => 'div', :class => 'col-sm-10' do |ba|
      ba.use :input, :class => 'form-control'
    end
  end

  config.wrappers :horizontal_search_collection_inline, :item_wrapper_class => 'form-check form-check-inline',
                                                        :item_label_class => 'form-check-label',
                                                        :tag => 'div',
                                                        :class => 'form-group row' do |b|
    b.use :html5
    b.use :label, :class => 'col-sm-2 col-form-label pt-0 text-right'
    b.wrapper :grid_wrapper, :tag => 'div', :class => 'col-sm-10' do |ba|
      ba.use :input, :class => 'form-check-input'
    end
  end

  config.wrappers :horizontal_search_multi_select, :tag => 'div',
                                                   :class => 'form-group row' do |b|
    b.use :html5
    b.use :label, :class => 'col-sm-2 col-form-label text-right'
    b.wrapper :grid_wrapper, :tag => 'div', :class => 'col-sm-10' do |ba|
  ...
  config.wrappers :horizontal_boolean, :tag => 'div',
    ...
    b.use :html5
    b.optional :readonly
    b.wrapper :tag => 'label', :class => 'col-sm-3 text-right' do |ba|
      ba.use :label_text
    end
  ...
  config.wrappers :horizontal_collection_inline, :item_wrapper_class => 'form-check form-check-inline',
    ...
    b.use :html5
    b.optional :readonly
    b.use :label, :class => 'col-sm-3 col-form-label pt-0 text-right'
    b.wrapper :grid_wrapper, :tag => 'div', :class => 'col-sm-9' do |ba|
      # ba.use :input, class: 'form-check-input', error_class: 'is-invalid', valid_class: 'is-valid'
      ba.use :input, :class => 'form-check-input', :error_class => 'is-invalid'
      ba.use :full_error, :wrap_with => { :tag => 'div', :class => 'invalid-feedback d-block' }
